...
All 139 software tests passed. Public tables and Figure 2 were regenerated in a freshly installed analysis environment and checked against an independent repository copy. Figure 2 retains the manuscript's 192 heatmap cell coordinates, colours, and labels; font rendering can differ between plotting environments.
